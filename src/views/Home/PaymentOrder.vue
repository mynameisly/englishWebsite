              ...
              <div class="columns columns-right btn-group pull-right">
                ...
                <div class="keep-open btn-group" title="列">
                  ...
                  <ul class="dropdown-menu" role="menu">
                    <li role="menuitem" v-for="(item,index) in headerList" :key="index">
                      <label
                        ><input
                          type="checkbox"
                ...
                >
                  ...
                  <tbody v-show="isToggle == true">
                    ...
                    >
                      ...
                      <td style="text-align: center; vertical-align: middle">
                        <a
                          v-if="item.set == '设置为已支付'"
                          href="javascript:;"
                          class="btn btn-info btn-view btn-xs"
                          ><i class="fa fa-check"></i>{{ item.set }}</a
                        >
                        <a
                          v-else
                          href="javascript:;"
                          class="btn btn-danger btn-chooseone btn-xs"
                          ><i class="fa fa-minus-square"></i>{{ item.set }}</a
                        >
                      </td>
                    </tr>
                  </tbody>
